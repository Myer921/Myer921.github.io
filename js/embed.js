...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6285355229697278721) {
        if (checkMobile()) {
...
function ua(e) {
    ...
    if (r = e.match(/FireFox\/([^\s]+)/ig)) {
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> 百毒浏览器'
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-qq"></i> 企鹅浏览器'
        /*.split('/')[0]*/
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_mi"><i class="fa fa-globe"></i> 粗粮浏览器'
        /*.split('/')[0]*/
    ...
    function() {
        ...
        H.SmiliesTooltip.prototype = {
            ...
            reset: function(e) {
                ...
                return i.each(q[e],
                function(t, r) {
                    var i = e.indexOf("\u5fae\u535a") === 0 ? "https://sinajs-cdn.morz.org/t35/style/images/common/face/ext/normal/" + r.replace("_org", "_thumb") : b + "/images/smilies/" + r;
                    e === "WordPress" && (t = " " + t + " "),
