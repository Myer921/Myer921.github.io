! function(e, t, s) {
    ...
    if (o.extend = function(e, t) {
        ...
        var Z = {
				...
				avatarUrl: function(e) {
					...
					if (e.avatar_url) {
						...
						e.avatar_url = e.avatar_url.replace(/himg\.bdimg\.com/, "bdimg.morz.org");//镜像源是baidu的https域名
						e.avatar_url = e.avatar_url.replace(/ds\.cdncache\.org/, "cdncache.morz.org");//镜像源是cdncache的https域名
						e.avatar_url = e.avatar_url.replace(/img\d+\.douban\.com/, "img2.doubanio.com");//豆瓣无需镜像
						e.avatar_url = e.avatar_url.replace(/app\.qlogo\.cn/, "qlogo.morz.org");//镜像源是qlogo的https域名
						e.avatar_url = e.avatar_url.replace(/tp\d+\.sinaimg\.cn/, "sinaimg.morz.org");//镜像源是sina的https域名
				} else {
						rt.data.default_avatar_url = "https://avatar.duoshuo.com/avatar-50/156/237713.jpg";
						}
				}
        ...
        et.commentList = function(e) {
            ...
            if (t += r() ? ' href="javascript:void(0);" onclick="return false"' : ' href="' + S.REMOTE + "/settings/avatar/" + x(T()) + '" target="_blank" title="设置头像"', t += ">" + et.avatarImg(nt.data) + '</a><form method="post">' + tt(e.params) + '<div class="ds-textarea-wrapper ds-rounded-top"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(z.leave_a_message) + '"></textarea><pre class="ds-hidden-text"></pre>', t += "</div>", t += '<div class="ds-post-toolbar"><div class="ds-post-options ds-gradient-bg">', !r() && nt.data.repostOptions) {
            }
            return  t += "</div>", t += '<button class="ds-post-button" type="submit">' + u(z.post) + '</button><div class="ds-toolbar-buttons">', e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote" title="插入表情"></a>'), e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'), t += "</div></div>", t += "</form></div>"
        ...
        it.on("queryDefined", function() {
            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function(e) {
                ...
                reset: function(e) {
                    function t(t, s) {
                        var i = 0 === e.indexOf("微博") ? "https://sinajs-cdn.morz.org/t35/style/images/common/face/ext/normal/" + s.replace("_org", "_thumb") : S.STATIC_URL + "/images/smilies/" + s;
